...
###### Side notes
1. If you get a message like this<br>
...
`| id                                   | name | subnets                                             |`<br>
`+--------------------------------------+------+-----------------------------------------------------+`<br>
`| bc0163a3-411c-4a4c-a483-c10d0fede952 | ext  | 07ba8cb8-54b4-41b4-8722-72280244f95f 10.1.1.0/24    |`<br>
`| c69600e7-a55d-4274-b87b-6d05a29794f3 | int  | 347d6eb8-7ee3-4ec9-aec0-38f82d1a7474 192.168.0.0/24 |`<br>
`+--------------------------------------+------+-----------------------------------------------------+`<br>

`# nova boot --poll --flavor m1-plus.tiny --key_name key1 --image d618db8e-abd8-452c-8802-5b03a7425cf5 --nic net-id=c69600e7-a55d-4274-b87b-6d05a29794f3 test-centos6`<br>
